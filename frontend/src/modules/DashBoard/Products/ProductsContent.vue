<template>
  <header class="flex flex-wrap items-center mt-6">
    ...
    <section class="grow text-slate-50 text-3xl text-center">Produtos</section>
...
<script setup lang="ts">
  ...
  import { productsData, dataInputs } from './services'
  import {
    productFind,
    productsAll as listProduct,
