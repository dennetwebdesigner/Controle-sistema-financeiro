<template>
  <header class="flex flex-wrap items-center mt-6">
    ...
    <section class="grow text-slate-50 text-3xl text-center">Vendas</section>
...
<script setup lang="ts">
  import { ref } from 'vue'
  import ProductAddModal from '../Modals/SaleAddModal.vue'
  import { SalesData, dataInputs } from './services'
  import {
    saleFind,
    salesAll as listProduct,
